...
/>
    ...
    <Box>
      <Heading fontSize='4xl' color={"#365349"} m='2'>Why Choose</Heading>
      <Heading fontSize='3xl' color={"#365349"} m='2'>Our Qualified Doctor?</Heading>
      <Text fontSize='xl' noOfLines={[1, 2, 3]} color={"#365349"} m='10px'>
...
<Box display={'flex'} justifyContent={'space-between'}  m='2'>
  ...
  <Text fontSize='xl'><CheckCircleIcon/> 20+ Years of Experience</Text>
  
  <Text fontSize='xl'><CheckCircleIcon/> MultiSpeciality Hospital</Text>
  </Box>
  <Box  display={'flex'} justifyContent={'space-between'}  m='2'>
  <Text fontSize='xl'><CheckCircleIcon/> 24 Hrs Medical Support</Text>
  <Text fontSize='xl'><CheckCircleIcon/> Proffessional Expert Doctor</Text>
  </Box>
  <Box alignItems={'left'} m='2'>
    ...
    <Box p='15' rounded='md' w='80%' margin={'auto'} display={'flex'}  alignItems={'center'} flexDirection={'column'}>
     <HStack spacing={'50px'} >
      <VStack>
   <Box   bgColor='two' h='100px' w='100px' borderRadius={'full'}>  <Center><Image w='50px' mt='5' src={require("../assets/charity.png")}/></Center></Box><Text as='b'>Charity</Text>
   </VStack>
   <VStack>
